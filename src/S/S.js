/*! capile/studio v2.0 | (c) 2025 Tecnodesign <ti@tecnodz.com> */
if(!('Studio' in window))window.Z=window.Studio={version:2.0, host:null, altHost:null,uid:'/_me',timeout:0,headers:{},env:'prod',timestamp:null,xhrCredentials:true,xhrHeaders:{'x-requested-with':'XMLHttpRequest'}};
(function(S) {
"use strict";
