...
?>
<div class="tdz-i-header"><?php foreach($Interface::$urls as $iurl=>$t): ?><a href="<?php echo $iurl ?>" class="tdz-i-title<?php if($iurl==$url) echo ' tdz-i-title-active'; ?>" data-url="<?php echo $iurl ?>"><?php echo $t; ?></a><?php endforeach;?></div>
